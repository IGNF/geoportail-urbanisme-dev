    ...
    <sld:NamedLayer>
        ...
        <sld:UserStyle>
            ...
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    <sld:Name>Ah-highscale</sld:Name>
                    <sld:Title>Zone agricole</sld:Title>
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>typezone</ogc:PropertyName>
                ...
                <sld:Rule>
                    <sld:Name>Nh-highscale</sld:Name>
                    <sld:Title>Zone naturelle et forestière</sld:Title>
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>typezone</ogc:PropertyName>
                ...
                <sld:Rule>
                    <sld:Name>Nd-highscale</sld:Name>
                    <sld:Title>Zone naturelle et forestière</sld:Title>
                    <ogc:Filter>
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>typezone</ogc:PropertyName>
